...
model_result <- run_model(specification = spec, dictionary = dict_statCan, inputdata_directory = df,primary_source = "local")#run_model(specification = spec, dictionary = dict_statCan, primary_source = "download")
browser()
